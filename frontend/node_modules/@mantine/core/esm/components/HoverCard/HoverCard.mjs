...
function HoverCard(props) {
  ...
  return /* @__PURE__ */ React.createElement(HoverCardContextProvider, { value: { openDropdown, closeDropdown } }, /* @__PURE__ */ React.createElement(Popover, __spreadProps(__spreadValues({}, others), { opened, __staticSelector: "HoverCard" }), children));
}
