...
import classes from './Mark.module.mjs';
...
const Mark = factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(Box, __spreadValues(__spreadValues({ component: "mark", ref, variant }, getStyles("root")), others));
});
