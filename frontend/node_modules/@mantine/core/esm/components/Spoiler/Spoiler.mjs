...
import classes from './Spoiler.module.mjs';
...
const Spoiler = factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(Box, __spreadValues(__spreadProps(__spreadValues({}, getStyles("root")), { id: _id, ref }), others), spoiler && /* @__PURE__ */ React.createElement(
    Anchor,
    __spreadValues({
      component: "button",
      type: "button",
