...
import classes from './Card.module.mjs';
...
const Card = polymorphicFactory((_props, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(CardProvider, { value: { getStyles } }, /* @__PURE__ */ React.createElement(Paper, __spreadValues(__spreadValues({ ref, unstyled }, getStyles("root")), others), content));
});
