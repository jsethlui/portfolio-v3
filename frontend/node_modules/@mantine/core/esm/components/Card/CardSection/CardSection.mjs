...
const CardSection = polymorphicFactory((_props, ref) => {
  ...
  const _a = props, { classNames, className, style, styles, vars, withBorder, inheritPadding } = _a, others = __objRest(_a, ["classNames", "className", "style", "styles", "vars", "withBorder", "inheritPadding"]);
