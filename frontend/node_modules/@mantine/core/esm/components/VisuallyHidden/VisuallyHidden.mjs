...
import classes from './VisuallyHidden.module.mjs';
...
const VisuallyHidden = factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(Box, __spreadValues(__spreadValues({ component: "span", ref }, getStyles("root")), others));
});
