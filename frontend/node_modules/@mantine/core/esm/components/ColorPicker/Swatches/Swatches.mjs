...
const Swatches = forwardRef(
  (_a, ref) => {
    ...
    const colors = data.map((color, index) => /* @__PURE__ */ React.createElement(
      ColorSwatch,
      __spreadProps(__spreadValues({}, ctx.getStyles("swatch")), {
    ...
    return /* @__PURE__ */ React.createElement(Box, __spreadValues(__spreadProps(__spreadValues({}, ctx.getStyles("swatches")), { ref }), others), colors);
  }
);
