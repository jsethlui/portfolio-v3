...
const Spoiler = factory.factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React__default.createElement(Box.Box, __spreadValues(__spreadProps(__spreadValues({}, getStyles("root")), { id: _id, ref }), others), spoiler && /* @__PURE__ */ React__default.createElement(
    Anchor.Anchor,
    __spreadValues({
      component: "button",
      type: "button",
    ...
    /* @__PURE__ */ React__default.createElement("div", { ref: contentRef }, children)
  ));
});
